          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden lg:flex items-center space-x-1">
                ...
                <Link href="/stocks" className="px-4 py-2 text-sm text-muted-foreground hover:text-emerald-400 hover:bg-emerald-500/10 rounded-lg transition-all flex items-center space-x-1">
                  <span>Stocks</span>
            ...
            <div className="flex items-center space-x-4">
              {isAuthenticated && user ? (
                <>
                  ...
                  <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-card/50 rounded-lg border border-border">
