                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-emerald-500/5 rounded-lg border border-emerald-500/20">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-xs"><span className="text-muted-foreground">Max Buy</span><button className="text-emerald-400 hover:underline">0.00 BTC</button></div>
                      <button
                  ...
                  <div className="p-4 bg-red-500/5 rounded-lg border border-red-500/20">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between text-xs"><span className="text-muted-foreground">Avbl</span><span>0.00 BTC</span></div>
                      {orderType !== "market" && (
                        <div>
                          <label className="text-xs text-muted-foreground mb-1 block">Price</label>
                          <div className="flex gap-2">
                      ...
                      <div className="flex items-center justify-between text-xs"><span className="text-muted-foreground">Max Sell</span><button className="text-red-400 hover:underline">0.00 BTC</button></div>
                      <button
