      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 rounded-xl p-4 mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="font-semibold text-sm">Welcome Bonus</div>
                <div className="text-xs text-muted-foreground">Get up to $5,000 on your first deposit</div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-card border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                    fieldErrors.firstName ? "border-red-500 focus:ring-red-500" : "border-border focus:ring-emerald-500"
                  }`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  disabled={isLoading}
                  className={`w-full px-4 py-3 bg-card border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                    fieldErrors.lastName ? "border-red-500 focus:ring-red-500" : "border-border focus:ring-emerald-500"
                  }`}
                />
            ...
            <div>
              ...
              <select
                ...
                required
                disabled={isLoading}
                className={`w-full px-4 py-3 bg-card border rounded-xl text-foreground focus:outline-none focus:ring-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                  fieldErrors.country ? "border-red-500 focus:ring-red-500" : "border-border focus:ring-emerald-500"
                }`}
              >
            ...
            <div>
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className="px-3 py-3 bg-card border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <option>
                    {formData.country
                      ? COUNTRIES.find(c => c.code === formData.country)?.phoneCode || '+1'
                      : '+1'
                    }
                  </option>
                </select>
                <input
                  ...
                  required
                  disabled={isLoading}
                  className={`flex-1 px-4 py-3 bg-card border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                    fieldErrors.phoneNumber ? "border-red-500 focus:ring-red-500" : "border-border focus:ring-emerald-500"
                  }`}
                />
              </div>
                ...
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`text-xs font-semibold ${
                      ...
                      strength.strength === 75 ? 'text-yellow-400' :
                      strength.strength === 50 ? 'text-orange-400' :
                      'text-red-400'
                    }`}>
                      {strength.label}
                    </span>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  disabled={isLoading}
                  className={`w-full px-4 py-3 pr-12 bg-card border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                    fieldErrors.confirmPassword ? "border-red-500 focus:ring-red-500" : "border-border focus:ring-emerald-500"
                  }`}
                />
                <button
                  type="button"
              ...
              <div>
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    ...
                    disabled={isLoading}
                    className="w-4 h-4 mt-0.5 rounded border-border text-emerald-500 focus:ring-2 focus:ring-emerald-500 bg-card disabled:opacity-50"
                  />
                ...
                {fieldErrors.terms && (
                  <p className="mt-1 text-sm text-red-400 ml-7">{fieldErrors.terms}</p>
                )}
              </div>
            </div>
        ...
        >
          <div className="flex items-center justify-center space-x-2">
            ...
            <span>Your data is protected with industry-leading security</span>
          </div>
        </motion.div>
      </div>
    </main>
