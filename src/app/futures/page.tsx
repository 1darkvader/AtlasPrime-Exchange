...
export default function FuturesPage() {
  ...
  const renderPositionsPanel = () => {
    const tabs = [
      ...
      { value: "orders" as const, label: "Open Orders", count: 0 },
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              {!isAuthenticated && (
                <div className="flex gap-3">
                  <Link href="/login" className="px-6 py-2 bg-card hover:bg-card/80 text-foreground font-semibold rounded transition-all">
                    Log In
                  </Link>
                  <Link href="/signup" className="px-6 py-2 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold rounded transition-all">
                    Register Now
                  </Link>
                </div>
              )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-emerald-500/5 rounded-lg border border-emerald-500/20">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        {isAuthenticated ? `Buy/Long ${currentPair.pair.split('/')[0]}` : 'Log In to Trade'}
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-red-500/5 rounded-lg border border-red-500/20">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        {isAuthenticated ? `Sell/Short ${currentPair.pair.split('/')[0]}` : 'Log In to Trade'}
                      </button>
                    </div>
                  </div>
                </div>
