      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="p-4 bg-card border border-border rounded-xl">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-mono break-all">0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb</span>
                <button className="ml-2 p-2 hover:bg-background rounded-lg transition-all">
          ...
          <div className="bg-orange-500/10 border border-orange-500/30 rounded-xl p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-orange-400">
                <strong>Important:</strong> Only send {selectedAsset} to this address via {selectedNetwork} network. Sending any other asset may result in permanent loss.
              </div>
            </div>
          </div>
          ...
          <div className="text-sm text-muted-foreground">
            Minimum deposit: <span className="font-semibold">10 {selectedAsset}</span>
          </div>
        </div>
      </motion.div>
    </motion.div>
