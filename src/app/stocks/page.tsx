...
const STOCK_PAIRS: TokenizedStock[] = [
  ...
  { symbol: "NVDA/USDT", binanceSymbol: "BTCUSDT", company: "NVIDIA", sector: "Blue Chip AI" },
  { symbol: "MSFT/USDT", binanceSymbol: "ETHUSDT", company: "Microsoft", sector: "Blue Chip AI" },
  { symbol: "GOOGL/USDT", binanceSymbol: "BNBUSDT", company: "Google (Alphabet)", sector: "Blue Chip AI" },
  { symbol: "AMD/USDT", binanceSymbol: "SOLUSDT", company: "Advanced Micro Devices", sector: "Blue Chip AI" },

  // Growth / High-Upside AI Stocks
  { symbol: "PLTR/USDT", binanceSymbol: "AVAXUSDT", company: "Palantir Technologies", sector: "Growth AI" },
  { symbol: "CRWD/USDT", binanceSymbol: "ADAUSDT", company: "CrowdStrike", sector: "Growth AI" },
  { symbol: "META/USDT", binanceSymbol: "DOTUSDT", company: "Meta Platforms", sector: "Growth AI" },
  { symbol: "TSLA/USDT", binanceSymbol: "MATICUSDT", company: "Tesla", sector: "Growth AI" },

  // High-Risk / High-Reward Frontier AI
  { symbol: "BKKT/USDT", binanceSymbol: "ATOMUSDT", company: "Bakkt Holdings", sector: "Frontier AI" },
  { symbol: "AI/USDT", binanceSymbol: "NEARUSDT", company: "C3.ai", sector: "Frontier AI" },
  { symbol: "SMCI/USDT", binanceSymbol: "ALGOUSDT", company: "Super Micro Computer", sector: "Frontier AI" },
  { symbol: "ARM/USDT", binanceSymbol: "ARBUSDT", company: "Arm Holdings", sector: "Frontier AI" },

  // Tech Giants & E-Commerce
  { symbol: "BABA/USDT", binanceSymbol: "LTCUSDT", company: "Alibaba", sector: "Tech Giants" },
  { symbol: "PYPL/USDT", binanceSymbol: "BCHUSDT", company: "PayPal", sector: "FinTech" },

  // Space & Aerospace
  { symbol: "RKLB/USDT", binanceSymbol: "FILUSDT", company: "Rocket Lab", sector: "Space" },
  { symbol: "SPACEX/USDT", binanceSymbol: "LINKUSDT", company: "SpaceX", sector: "Space" },

  // Quantum Computing
  { symbol: "IONQ/USDT", binanceSymbol: "QNTUSDT", company: "IonQ Inc", sector: "Quantum" },

  // Hardware & Storage
  { symbol: "WDC/USDT", binanceSymbol: "ARUSDT", company: "Western Digital", sector: "Hardware" },

  // FinTech & Banking
  { symbol: "SOFI/USDT", binanceSymbol: "APEUSDT", company: "SoFi Technologies", sector: "FinTech" },
  { symbol: "STRIPE/USDT", binanceSymbol: "AXSUSDT", company: "Stripe", sector: "FinTech" },
  { symbol: "REVOLUT/USDT", binanceSymbol: "MANAUSDT", company: "Revolut", sector: "FinTech" },
  { symbol: "KALSHI/USDT", binanceSymbol: "GALAUSDT", company: "Kalshi", sector: "Prediction Markets" },

  // AI Startups (Pre-IPO/Tokenized)
  { symbol: "ANTHROPIC/USDT", binanceSymbol: "RENDERUSDT", company: "Anthropic", sector: "AI Startups" },
  { symbol: "XAI/USDT", binanceSymbol: "FETUSDT", company: "xAI", sector: "AI Startups" },
  { symbol: "PERPLEXITY/USDT", binanceSymbol: "AGIXUSDT", company: "Perplexity", sector: "AI Startups" },
  { symbol: "SCALEAI/USDT", binanceSymbol: "OCEANUS DT", company: "Scale AI", sector: "AI Startups" },

  // Robotics & Automation
  { symbol: "FIGUREAI/USDT", binanceSymbol: "INJUSDT", company: "Figure AI", sector: "Robotics" },
  { symbol: "RIPCORD/USDT", binanceSymbol: "STXUSDT", company: "Ripcord", sector: "Robotics" },
  { symbol: "NEURALINK/USDT", binanceSymbol: "ROSEUSDT", company: "Neuralink", sector: "BCI Tech" },

  // Defense & Security
  { symbol: "ANDURIL/USDT", binanceSymbol: "WLDUSDT", company: "Anduril", sector: "Defense Tech" },

  // Exchange Tokens
  { symbol: "COIN/USDT", binanceSymbol: "UNIUSDT", company: "Coinbase", sector: "Crypto Exchange" },
  ...
  // Blockchain Finance
  { symbol: "RIPPLE/USDT", binanceSymbol: "XRPUSDT", company: "Ripple", sector: "Crypto FinTech" },
